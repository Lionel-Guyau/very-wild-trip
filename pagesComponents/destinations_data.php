...
$destinations = [
    ...
    'Sydney' => [
        ...
        'changeOfScenery' => 2,
        'wheather' => 'Chaud',
        'description' => "<p>zNon, Sydney n'est pas la capitale de l'Australie, mais elle est à coup sûr le ville la plus attractive du pays : pour son site, ses plages, son activité, son ambiance et sa dimension culturelle, Sydney reste l'étape incontournable de tout voyage australien.</p>",    
    ],
